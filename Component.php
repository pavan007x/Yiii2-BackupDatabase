<?php
/**
 * @link https://PavanNayak.tk/
 * @copyright Copyright (c) 2017 Pavan Nayak Alias KingVipz
 * @author Pavan <Pavan084612@gmail.com>
 */

namespace Pavan\backup;
...
class Component extends \yii\base\Component
{
     ...
     * if callable:
     * function(\Pavan\backup\Component $component) {
    ...
    public function deleteJunk()
    {
        ...
        foreach ($files as $file) {
            if (@unlink($file)) {
                Yii::info('Backup file was deleted: ' . $file, 'Pavan\backup\Component::deleteJunk()');
            } else {
                Yii::error('Cannot delete backup file: ' . $file, 'Pavan\backup\Component::deleteJunk()');
            }
        }
